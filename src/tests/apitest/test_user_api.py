...
from hackathon.constants import HackathonNotifyEvent, HackathonNotifyCategory
from hackathon.db.models import HackathonNotice
...
class TestUserInfoApi(ApiTestCase):
    ...
    def test_read_user_notice(self, user1):
        ...
        hackathon_notice = HackathonNotice(
            content='',
            link='',
            event=HackathonNotifyEvent.HACK_CREATE,
            category=HackathonNotifyCategory.HACKATHON,
            receiver=user1,
            creator=user1,
        )
