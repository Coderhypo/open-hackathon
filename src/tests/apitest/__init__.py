...
from hackathon.db.models import UserToken
from hackathon.db.database import drop_db, setup_db
...
class ApiTestCase(object):
    ...
    def login(self, user):
        ...
        user_token.save()
        self.client.update_headers({constants.HttpHeader.AUTHORIZATION: user_token.token})
        return user_token

    def set_hackathon_name(self, hackathon_name):
        self.client.update_headers({constants.HttpHeader.HACKATHON_NAME: hackathon_name})
