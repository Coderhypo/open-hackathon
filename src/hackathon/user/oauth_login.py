...
from hackathon.constants import LoginProviderName
...
class WechatLogin(LoginBase):
    ...
    def login(self, context):
        ...
        return {
            "openid": openid,
            "provider": LoginProviderName.WECHAT,
...
class GithubLogin(LoginBase):
    ...
    def login(self, context):
        ...
        required_info = {
            ...
            "provider": LoginProviderName.GITHUB,
            "name": name,
            "nickname": nickname,
            "access_token": access_token,
...
class WeiboLogin(LoginBase):
    ...
    def login(self, context):
        ...
        required_info = {
            "openid": str(user_info["id"]),
            "provider": LoginProviderName.WEIBO,
            "name": name,
...
class LiveLogin(LoginBase):
    ...
    def login(self, context):
        ...
        required_info = {
            "openid": user_info["id"],
            "provider": LoginProviderName.LIVE,
            "name": name,
            "nickname": name,
            "access_token": access_token,
            "email_list": email_list,
...
login_providers = {
    LoginProviderName.GITHUB: GithubLogin(),
    LoginProviderName.WEIBO: WeiboLogin(),
    LoginProviderName.QQ: QQLogin(),
    LoginProviderName.LIVE: LiveLogin(),
    LoginProviderName.WECHAT: WechatLogin()
}
