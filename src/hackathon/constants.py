...
class VoiceVerifyProvider:
    """Voice_Verify service providers"""
    RONGLIAN = "rong_lian"


class VoiceVerifyRongLianStatusCode:
...
class SmsChinaTeleComTemplate:
    """SMS-template of ChinaTelecom"""
    DEFAULT = ""


class SmsChinaTeleComStatusCode:
...
class ChinaTeleComAccessTokenStatusCode:
