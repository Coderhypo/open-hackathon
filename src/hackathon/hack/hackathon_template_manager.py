...
from hackathon.db.models import Template

from hackathon import Component, RequiredFeature, Context
from hackathon.constants import VirtualEnvProvider, TemplateStatus, CloudProvider
...
class HackathonTemplateManager(Component):
    ...
    def __get_images_from_template(self, template):
        ...
        docker_units = [u for u in template_content.units if u.provider == VirtualEnvProvider.DOCKER]
    ...
    def __get_templates_for_pull(self, hackathon_id):
        ...
        templates = [t for t in templates if t.provider == VirtualEnvProvider.DOCKER and t.status == TemplateStatus.CHECK_PASS]
        return templates
