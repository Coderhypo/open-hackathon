...
from hackathon.constants import FileType, HealthStatus, Health
...
class AzureStorage(Storage):
    ...
    def __init__(self):
        self.__containers = {
            FileType.TEMPLATE: self.util.safe_get_config("storage.azure.template_container", "templates"),
            FileType.HACK_IMAGE: self.util.safe_get_config("storage.azure.image_container", "images"),
            FileType.AZURE_CERT: self.util.safe_get_config("storage.azure.certificate_container", "certificate"),
            FileType.USER_FILE: self.util.safe_get_config("storage.azure.user_file_container", "userfile"),
            FileType.TEAM_FILE: self.util.safe_get_config("storage.azure.team_file_container", "teamfile"),
            FileType.HACK_FILE: self.util.safe_get_config("storage.azure.hack_file_container", "hackfile"),
        }
    ...
    def __get_container_by_file_type(self, file_type):
        ...
        :param file_type: type of file defined at FileType in constants.py
        """
    ...
    def __generate_file_name(hackathon_name, file_type, file_name):
        ...
        """
        if file_type == FileType.HACK_IMAGE:
