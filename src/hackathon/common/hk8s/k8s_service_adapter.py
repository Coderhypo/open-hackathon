...
from hackathon.constants import Health, HealthStatus, K8sDeploymentStatus
...
class K8SServiceAdapter(ServiceAdapter):
    ...
    def ping(self, timeout=20):
        ...
        return report[Health.STATUS] == HealthStatus.OK
    ...
    def get_deployment_status(self, deployment_name):
        ...
        if not _status.replicas:
            return K8sDeploymentStatus.PAUSE
        if _status.replicas == _status.available_replicas:
            return K8sDeploymentStatus.AVAILABLE
        if _status.unavailable_replicas > 0:
            return K8sDeploymentStatus.ERROR
        return K8sDeploymentStatus.PENDING
