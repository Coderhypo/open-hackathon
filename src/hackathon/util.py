...
from hackathon.constants import EmailSmtpStatusCode, VoiceVerifyRongLianStatusCode, SmsChinaTeleComTemplate, \
    SmsChinaTeleComStatusCode, ChinaTeleComAccessTokenStatusCode
...
class Email(object):
    ...
    def send_emails(self, sender, receivers, subject, content, cc=[], bcc=[], attachments=[]):
        ...
        try:
            ...
            if response.status_code == EmailSmtpStatusCode.SUCCESS:
                return True
...
class RonglianVoiceVerify(VoiceVerify):
    ...
    def send_voice_verify(self, receiver, content):
        ...
        try:
            ...
            if response["statusCode"] == VoiceVerifyRongLianStatusCode.SUCCESS:
                return True
...
class Sms(object, metaclass=abc.ABCMeta):
    ...
    def send_sms(self, receiver, template_id, content):
        ...
        Example:
            XXX.send_sms("18217511111", SmsChinaTeleComTemplate.DEFAULT, {"param1": "1849"})

        :type receiver: str|unicode
        :param receiver: the telephone number. Example: "18217511111"

        :type template_id: constant integer
        :param template_id: the id of sms-template. Example: SmsChinaTeleComTemplate.DEFAULT
...
class ChinaTelecomSms(Sms):
    ...
    def send_sms(self, receiver, template_id, content):
        ...
        try:
            ...
            if response_json["res_code"] == SmsChinaTeleComStatusCode.SUCCESS:
                return True
    ...
    def __get_access_token(self):
        ...
        try:
            ...
            response = urllib.request.urlopen(req)
            response_json = json.loads(response.read())
            if response_json["res_code"] == ChinaTeleComAccessTokenStatusCode.SUCCESS:
                # access_token's expiration time is 30 days.
